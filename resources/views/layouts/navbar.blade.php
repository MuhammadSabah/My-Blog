<nav class="navbar-expand-sm navbar navbar-dark bg-dark sticky-top">
    <div class="container-fluid nav-container px-5">
        <a class="navbar-brand bootstrap-icon p-0 me-0 me-lg-2 nav-icon" aria-label="Bootstrap">
